...
import ua.ithillel.lesson6.main.java.MethodsClass;
...
import static ua.ithillel.lesson6.main.java.MethodsClass.countOccurance;


public class MethodsTest {
    private static final List<String> wordsList = List.of("one", "two", "three", "four", "five", "one",
            "two", "two", "two", "four", "one");
    private List<String> resultList = List.of(Map.of("name", "four", "occurrence", "2").toString(),
            Map.of("name", "one", "occurrence", "3").toString(),
